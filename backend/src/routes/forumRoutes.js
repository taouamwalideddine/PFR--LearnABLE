...
const { createPost, getPosts, getPostById, likePost, deletePost, addComment, deleteComment } = require('../controllers/forumController');
...
router.route('/posts/:id/like').patch(likePost);
